...
import com.example.mattimoestechshop.Customer.ProductDetails;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextView tvProductName, tvProductPrice, tvProductManufacturer, tvProductState , tvProductCategory, tvProductDescription;


        public MyViewHolder(View itemView) {
            super(itemView);
            tvProductName = (TextView) itemView.findViewById(R.id.productNametxt);
            tvProductPrice = (TextView) itemView.findViewById(R.id.productPricetxt);
